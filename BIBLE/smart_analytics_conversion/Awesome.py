...
left_data['acronym'] = left_data['acronym'].str.replace(r'-L$', '')
right_data['acronym'] = right_data['acronym'].str.replace(r'-R$', '')
...
final_data.to_csv('processed_dataDoesthisWork.csv', index=False)
